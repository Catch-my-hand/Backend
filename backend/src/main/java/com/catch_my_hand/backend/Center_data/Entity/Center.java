...
public class Center {
    ...
    public String toString() {
        return "Center [ id= " + id + ", happenDt= + " + happenDt + ", processState=" + processState  + ", noticeEdt=" +noticeEdt + ", kindCd=" 
        + kindCd + ", colorCd=" + colorCd + ", age=" + age + ", weight=" +weight + ", sexCd=" + sexCd + ", neuterYn=" + neuterYn + ", specialMark=" + 
        specialMark + ", careNm=" + careNm + ", careAddr=" + careAddr + ", orgNm=" + orgNm + ", popfile=" + popfile + ", filename=" + filename + "]";
}
}
